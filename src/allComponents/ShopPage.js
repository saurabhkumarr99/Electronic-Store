            ...
            <div className="container mx-auto">
                <div className="row">
                    ...
                    <div className="col-md-4 mb-3">
                        <div className="card">
                            <img
                                src="../../images/images.jpeg" // Replace with your image URL
                    ...
                    <div className="col-md-4 mb-3">
                        <div className="card">
                            <img
                                src="../../images/laptop1.jpeg" // Replace with your image URL
                                className="card-img-top"
                                alt="Laptop"
                                style={{ maxWidth: '100%', height: '295px' }}
                            />
                    ...
                    <div className="col-md-4 mb-3">
                        <div className="card">
                            <img
                                src="../../images/laptop2.jpeg" // Replace with your image URL
                                className="card-img-top"
                                alt="Laptop"
